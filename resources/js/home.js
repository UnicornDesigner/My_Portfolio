...
gradient.addColorStop(0, "#6e0a6a");
gradient.addColorStop(1, "#521d43");
...
function animate() {
    ...
    mountains(1, canvas.height - 50, "#470936");
    mountains(2, canvas.height - 100, "#470947");
    mountains(3, canvas.height - 300, "#390947");
